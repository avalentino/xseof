...
xsdata generate -p xseof.int_attdef.v01xx EE_CFI_SCHEMAS/EO_OPER_INT_ATTDEF_0104.XSD
xsdata generate -p xseof.int_attdef.v02xx EE_CFI_SCHEMAS/EO_OPER_INT_ATTDEF_0205.XSD
xsdata generate -p xseof.int_attdef.v03xx EE_CFI_SCHEMAS/EO_OPER_INT_ATTDEF_0302.XSD
